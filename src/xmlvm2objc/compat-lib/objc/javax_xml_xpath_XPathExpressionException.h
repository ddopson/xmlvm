...
- (void) __javax_xml_xpath_XPathExpressionException___java_lang_String: (java_lang_String*) msg;
- (void) __javax_xml_xpath_XPathExpressionException___java_lang_String_java_lang_Throwable: (java_lang_String*) msg: (java_lang_Throwable*) cause;
