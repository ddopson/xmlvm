...
- (void) __init_java_lang_StringBuilder___int: (int) length;
...
- (java_lang_StringBuffer*) append___char: (JAVA_CHAR) i;
- (java_lang_StringBuffer*) append___float: (float) f;
- (java_lang_StringBuffer*) append___double: (double) d;
- (java_lang_StringBuffer*) append___boolean: (JAVA_BOOLEAN) b;
